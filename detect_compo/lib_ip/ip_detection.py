...
def rm_top_or_bottom_corners(components, org_shape, top_bottom_height=20):
    new_compos = []
...
def rm_line_v_h(binary, show=False, max_line_thickness=5):
...
def detect_compos_in_img(compos, binary, org, max_compo_scale=0.9, show=False):
